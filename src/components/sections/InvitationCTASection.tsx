  ...
  return (
    <section className="bg-light-950 py-16 md:py-8">
      <div className="flex flex-col items-center gap-6 p-4 md:w-full md:gap-8 md:px-10 lg:mx-auto lg:w-[1028px] lg:gap-10 lg:px-0">
        <h2 className="w-[288px] md:w-[320px] text-center font-oleo text-[40px] text-reef-300 md:text-[48px]">
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          <a
            href="#newsletter"
            className="flex h-12 w-full items-center justify-center rounded-lg border border-reef-300 md:w-[288px] font-groteskspace text-reef-300 hover:bg-reef-300 hover:text-light-950"
          >
            Newsletter
          </a>
        </div>
